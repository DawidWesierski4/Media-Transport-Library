...
if [[ ${BASH_SOURCE} == ${0} ]]; then
    ...
    function_test2 $VFIO_PORT_1 $IP_PORT_2 $VFIO_PORT_2_2 $IP_PORT_1 ${LOG_FILE}_1 "1,2" &

    function_test2 $VFIO_PORT_3 $IP_PORT_4 $VFIO_PORT_4_2 $IP_PORT_3 ${LOG_FILE}_2 "3,4" &

    function_test2 $VFIO_PORT_5 $IP_PORT_6 $VFIO_PORT_6_2 $IP_PORT_5 ${LOG_FILE}_3 "4,5" &
